...
def Screen():
    ...
    # Text-label saying "Welcome" placed top/center
    Good_Label = tk.Label(window, text='Welcome')  # Make label on "window"
    ...
    # Text-label asking which program the user wants to pick
    Good_Label2 = tk.Label(window, text='Which program would you like?')  # Make label on "window"
    Good_Label2.config(font=('helvetica', 24))  # Set the font-family and -size
    Good_Label2.place(x=250, y=250, anchor="center")  # Place in top/center of window
    ...
    exitbutton.config(font=('helvetica', 28))  # Set the font-family and -size
    ...
    restartbutton.config(font=('helvetica', 28))  # Set the font-family and -size
    ...
    hatbutton.config(font=('helvetica', 28))  # Set the font-family and -size
